...
export default function AdminLayout() {
  ...
  if (!authenticated) {
    return (
      <div dir="rtl" className="flex min-h-screen items-center justify-center bg-[#061B4F] px-4 py-8">
        <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl">
          <div className="bg-[#061B4F] px-6 py-10 text-center text-white">
            ...
            <p className="mt-2 text-sm text-white/60">مدیریت فروشگاه AVITA</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5 p-6 sm:p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    // چشم باز = رمز نمایش داده می‌شود
                    <Eye className="h-5 w-5" />
                  ) : (
                    // چشم بسته = رمز مخفی است
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#f7f7f5] text-[#111827]">
      <div className="flex min-h-screen">
        <aside className="fixed right-0 top-0 z-40 hidden h-screen w-64 border-l border-gray-200 bg-white lg:block">
          <div className="flex h-full flex-col">
            <div className="flex h-20 items-center justify-center border-b border-gray-100">
              <div className="text-2xl font-bold tracking-[0.18em] text-[#061B4F]">AVITA</div>
            </div>
        ...
        <main className="min-h-screen w-full lg:mr-64">
          <header className="sticky top-0 z-30 flex min-h-20 items-center justify-between gap-4 border-b border-gray-200 bg-white/95 px-4 py-3 backdrop-blur sm:px-6">
            <div>
              <h1 className="text-base font-semibold text-[#061B4F] sm:text-lg">پنل مدیریت AVITA</h1>
              <p className="mt-1 text-xs text-gray-400">مدیریت فروشگاه</p>
            </div>

            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex items-center gap-2 rounded-full bg-[#061B4F]/5 px-3 py-2 text-xs font-medium text-[#061B4F] sm:px-4">
